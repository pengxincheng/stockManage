    ...
    <div class="main-content">
        ...
        <div class="main-content-inner padding-page-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="role" name="role" action="../../productType/add"
                              method="post">
                            <input type="hidden" id="typeId" name="productType.typeId">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="typeName">类别名称</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control"
                                           placeholder="类别名称" id="typeName" name="productType.typeName"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control"
                                           placeholder="备注" id="remark" name="productType.remark"/>
                                </div>
                            </div>
                        </form>
    ...
    jQuery(function ($) {
        ...
        $("#btnSave").on(ace.click_event, function () {
            ...
            if ($('#role').validationEngine('validate')) {
                ...
                $.post("../../productType/addOrUpdate", params, function (data) {
                    if (data.resultJson.result == 'SUCCESS') {
                        alert("操作成功！");
                        location.href = 'productTypeList.jsp'
                    } else {
                        alert("操作失败!");
                    }
                });
        ...
        if (getUrlParam("id")) {
            ...
            $.get("../../productType/getById", {id: id}, function (data) {
