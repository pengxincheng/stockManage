                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" id="form1" action="index.html" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="roleName">
                                    角色名称
                                </label>
                                <div class="col-sm-3">
                                ...
                                <label class="col-sm-1 control-label no-padding-right" for="roleCode">
                                    角色编号
                                </label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" placeholder="角色编号" id="roleCode"
                                           name="roleCode"/>
