    ...
    <div class="main-content">
        ...
        <div class="main-content-inner padding-page-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="role" name="role" action="../../role/add" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="roleName">角色名称</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control" placeholder="角色名称" id="roleName" name="role.roleName"/>
                                </div>                                            
                            </div>
                            
							<div class="form-group">
                               <label class="col-sm-1 control-label no-padding-right" for="roleCode">角色编码</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control" placeholder="角色编码" id="roleCode" name="role.roleCode"/>
                                </div> 
                            </div>							
                        </form>
