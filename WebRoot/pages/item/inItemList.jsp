    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-40">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>商品详情列表</li>
                </ul><!-- /.breadcrumb -->
            </div>
        </div>
                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" id="form1" action="index.html" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-1 control-label no-padding-right" for="itemStatus">状态</label>
                                <div class="col-sm-2">
                                    <select class="form-control" id="itemStatus" name="item.itemStatus"
                                            data-validation-engine="validate[required]">
                                        <option value="" selected="selected">-请选择-</option>
                                    ...
                                    <div>
                                        <table id="example" class="table table-striped  table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="align-center">商品类别</th>
                                                <th class="align-center">供应商</th>
                                                <th class="align-center">生产日期</th>
                                                <th class="align-center">所在仓库</th>
