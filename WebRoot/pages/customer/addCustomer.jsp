    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-82">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>新增客户</li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="role" name="role" action="../../user/add"
                            ...
                            <input type="hidden" id="userType" name="user.userType" value="customer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control"
                                           placeholder="客户姓名" id="userAlias" name="user.userAlias"/>
                                </div>
                            </div>
                            <div class="form-group">
