    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-40">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>库存列表</li>
                </ul><!-- /.breadcrumb -->
            </div>
        </div>
                                    ...
                                    <div>
                                        <table id="example" class="table table-striped  table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="align-center">总入库</th>
                                                <th class="align-center">总出库</th>
                                                <th class="align-center">实际库存</th>
                                                <th class="align-center">是否告警</th>
