    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-40">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>供应商列表</li>
                </ul><!-- /.breadcrumb -->
            </div>
        </div>
                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" id="form1" action="index.html" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="userAlias">供应商</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" placeholder="供应商" id="userAlias" name="user.userAlias"/>
                                </div>
