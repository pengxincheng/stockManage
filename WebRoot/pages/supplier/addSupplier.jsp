    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-82">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>新增供应商</li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="role" name="role" action="../../user/add"
                            ...
                            <input type="hidden" id="userType" name="user.userType" value="supplier">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="userAlias">供应商名称</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control"
                                           placeholder="供应商姓名" id="userAlias" name="user.userAlias"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="userName">联系人</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control"
                                           placeholder="联系人" id="userName" name="user.userName"/>
                                </div>
            ...
            if ($('#role').validationEngine('validate')) {
                ...
                $.post("../../user/add", params, function (data) {
                    if (data.resultJson.result == 'SUCCESS') {
                        alert("操作成功！");
                        location.href = 'supplierList.jsp'
                    } else {
                        alert("操作失败!");
                    }
                });
